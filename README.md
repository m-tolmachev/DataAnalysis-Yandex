...
<td>Вы работаете аналитиком в Яндекс.Дзене. Почти всё ваше время занимает анализ пользовательского взаимодействия с карточками статей.
...
На шестую неделю работы вы решаете, что процесс пора автоматизировать. Для Дениса и Валерии нужно сделать дашборд.;<a href="https://github.com/m-tolmachev/DataAnalysis-Yandex/blob/master/Яндекс%20Презентация.pdf" target="_blank"><b>Описание реузльтатов дэшборда</b></a></td>
<td>pandas, numpy, matplotlib, scipy, plotly, </b>math</b></td>
<tr>
